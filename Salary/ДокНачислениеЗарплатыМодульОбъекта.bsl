...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	// Получение СПИСКА Видов Расчета
	...
	ВыборкаВидыРасчета = РезультатЗапроса.Выбрать();
	
	МассивВидовРасчета = Новый Массив;
	
	Пока ВыборкаВидыРасчета.Следующий() Цикл
		
		МассивВидовРасчета.Добавить(ВыборкаВидыРасчета.ВидРасчета)
		
	КонецЦикла;


	//Вызов Процедуры Общего Модуля
	
	ОбращениеКДанным.РассчитатьНачисления(Движения, Ссылка, МассивВидовРасчета);
